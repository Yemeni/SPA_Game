		...
		if(main.get('wood') >= self.tile[tilenum].get('cost_wood')
			...
			switch(name){
				case "Wood Cutter":
					switch(level){
						case 3 :
						tile[tilenum].set('img' , 'dist/images/Pinewood_Cutter_Level_2.png');
						break;
						
						case 5 :
						tile[tilenum].set('img' , 'dist/images/Pinewood_Cutter_Level_3.png');
						break;
						
						case 7 :
						tile[tilenum].set('img' , 'dist/images/Pinewood_Cutter_Level_4.png');
						break;
						
						case 9 :
						tile[tilenum].set('img' , 'dist/images/Pinewood_Cutter_Level_5.png');
						break;
					}
				break;
				case "Mason":
					switch(level){
						case 3 :
						tile[tilenum].set('img' , 'dist/images/Mason_Level_2.png');
						break;
						
						case 5 :
						tile[tilenum].set('img' , 'dist/images/Mason_Level_3.png');
						break;
						
						case 7 :
						tile[tilenum].set('img' , 'dist/images/Mason_Level_4.png');
						break;
						
						case 9 :
						tile[tilenum].set('img' , 'dist/images/Mason_Level_5.png');
						break;
					}
				break;
				case "Wood Swamill":
					switch(level){
						case 3 :
						tile[tilenum].set('img' , 'dist/images/Pinewood_Sawmill_Level_2.png');
						break;
						
						case 5 :
						tile[tilenum].set('img' , 'dist/images/Pinewood_Sawmill_Level_3.png');
						break;
						
						case 7 :
						tile[tilenum].set('img' , 'dist/images/Pinewood_Sawmill_Level_4.png');
						break;
						
						case 9 :
						tile[tilenum].set('img' , 'dist/images/Pinewood_Sawmill_Level_5.png');
						break;
					}
				break;
				...
				case "Storage":
					switch(level){
						case 3 :
						tile[tilenum].set('img' , 'dist/images/Storehouse_Level_2.png');
						break;
						
						case 5 :
						tile[tilenum].set('img' , 'dist/images/Storehouse_Level_3.png');
						break;
						
						case 7 :
						tile[tilenum].set('img' , 'dist/images/Storehouse_Level_4.png');
						break;
						
						case 9 :
						tile[tilenum].set('img' , 'dist/images/Storehouse_Level_5.png');
						break;
					}
				break;
				...
				case "Residence":
					switch(level){
						case 3 :
						tile[tilenum].set('img' , 'dist/images/Residence_Level_2.png');
						break;
						
						case 5 :
						tile[tilenum].set('img' , 'dist/images/Residence_Level_3.png');
						break;
						
						case 7 :
						tile[tilenum].set('img' , 'dist/images/Residence_Level_4.png');
						break;
						
						case 9 :
						tile[tilenum].set('img' , 'dist/images/Residence_Level_5.png');
						break;
					}
				break;
			}
